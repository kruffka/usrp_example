...
simde__m512i simde_mm512_4dpwssd_epi32(simde__m512i src,
                                       simde__m512i a0,
                                       simde__m512i a1,
                                       simde__m512i a2,
                                       simde__m512i a3,
                                       simde__m128i *b)
{
    ...
    r = simde_mm512_add_epi32(simde_mm512_dpwssd_epi32(src, a1, simde_mm512_set1_epi32(bv.i32[1])),
                              r);
    r = simde_mm512_add_epi32(simde_mm512_dpwssd_epi32(src, a2, simde_mm512_set1_epi32(bv.i32[2])),
                              r);
    r = simde_mm512_add_epi32(simde_mm512_dpwssd_epi32(src, a3, simde_mm512_set1_epi32(bv.i32[3])),
                              r);
...
#define _mm512_4dpwssd_epi32(src, a0, a1, a2, a3, b)                                               \
    simde_mm512_4dpwssd_epi32(src, a0, a1, a2, a3, b)
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_mask_4dpwssd_epi32(simde__m512i src,
                                            simde__mmask16 k,
                                            simde__m512i a0,
                                            simde__m512i a1,
                                            simde__m512i a2,
...
#define _mm512_mask_4dpwssd_epi32(src, k, a0, a1, a2, a3, b)                                       \
    simde_mm512_mask_4dpwssd_epi32(src, k, a0, a1, a2, a3, b)
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_maskz_4dpwssd_epi32(simde__mmask16 k,
                                             simde__m512i src,
                                             simde__m512i a0,
                                             simde__m512i a1,
                                             simde__m512i a2,
...
#define _mm512_maskz_4dpwssd_epi32(k, src, a0, a1, a2, a3, b)                                      \
    simde_mm512_maskz_4dpwssd_epi32(k, src, a0, a1, a2, a3, b)
#endif
