...
simde__m128 simde_mm_scalef_ps(simde__m128 a, simde__m128 b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
    return _mm_scalef_ps(a, b);
#else
    return simde_mm_mul_ps(simde_x_mm_flushsubnormal_ps(a),
                           simde_mm_exp2_ps(simde_mm_floor_ps(simde_x_mm_flushsubnormal_ps(b))));
#endif
}
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_mask_scalef_ps(simde__m128 src, simde__mmask8 k, simde__m128 a, simde__m128 b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_maskz_scalef_ps(simde__mmask8 k, simde__m128 a, simde__m128 b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256 simde_mm256_scalef_ps(simde__m256 a, simde__m256 b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
    return _mm256_scalef_ps(a, b);
#else
    return simde_mm256_mul_ps(
        simde_x_mm256_flushsubnormal_ps(a),
        simde_mm256_exp2_ps(simde_mm256_floor_ps(simde_x_mm256_flushsubnormal_ps(b))));
#endif
}
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256 simde_mm256_mask_scalef_ps(simde__m256 src,
                                       simde__mmask8 k,
                                       simde__m256 a,
                                       simde__m256 b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256 simde_mm256_maskz_scalef_ps(simde__mmask8 k, simde__m256 a, simde__m256 b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512 simde_mm512_scalef_ps(simde__m512 a, simde__m512 b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE)
    return _mm512_scalef_ps(a, b);
#else
    return simde_mm512_mul_ps(
        simde_x_mm512_flushsubnormal_ps(a),
        simde_mm512_exp2_ps(simde_mm512_floor_ps(simde_x_mm512_flushsubnormal_ps(b))));
#endif
}
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512 simde_mm512_mask_scalef_ps(simde__m512 src,
                                       simde__mmask16 k,
                                       simde__m512 a,
                                       simde__m512 b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512 simde_mm512_maskz_scalef_ps(simde__mmask16 k, simde__m512 a, simde__m512 b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_scalef_pd(simde__m128d a, simde__m128d b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
    return _mm_scalef_pd(a, b);
#else
    return simde_mm_mul_pd(simde_x_mm_flushsubnormal_pd(a),
                           simde_mm_exp2_pd(simde_mm_floor_pd(simde_x_mm_flushsubnormal_pd(b))));
#endif
}
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_mask_scalef_pd(simde__m128d src,
                                     simde__mmask8 k,
                                     simde__m128d a,
                                     simde__m128d b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_maskz_scalef_pd(simde__mmask8 k, simde__m128d a, simde__m128d b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256d simde_mm256_scalef_pd(simde__m256d a, simde__m256d b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
    return _mm256_scalef_pd(a, b);
#else
    return simde_mm256_mul_pd(
        simde_x_mm256_flushsubnormal_pd(a),
        simde_mm256_exp2_pd(simde_mm256_floor_pd(simde_x_mm256_flushsubnormal_pd(b))));
#endif
}
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256d simde_mm256_mask_scalef_pd(simde__m256d src,
                                        simde__mmask8 k,
                                        simde__m256d a,
                                        simde__m256d b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256d simde_mm256_maskz_scalef_pd(simde__mmask8 k, simde__m256d a, simde__m256d b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512d simde_mm512_scalef_pd(simde__m512d a, simde__m512d b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE)
    return _mm512_scalef_pd(a, b);
#else
    return simde_mm512_mul_pd(
        simde_x_mm512_flushsubnormal_pd(a),
        simde_mm512_exp2_pd(simde_mm512_floor_pd(simde_x_mm512_flushsubnormal_pd(b))));
#endif
}
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512d simde_mm512_mask_scalef_pd(simde__m512d src,
                                        simde__mmask8 k,
                                        simde__m512d a,
                                        simde__m512d b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512d simde_mm512_maskz_scalef_pd(simde__mmask8 k, simde__m512d a, simde__m512d b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_scalef_ss(simde__m128 a, simde__m128 b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE)
    ...
    a_.f32[0] =
        (simde_math_issubnormalf(a_.f32[0]) ? 0 : a_.f32[0]) *
        simde_math_exp2f(simde_math_floorf((simde_math_issubnormalf(b_.f32[0]) ? 0 : b_.f32[0])));
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_mask_scalef_ss(simde__m128 src, simde__mmask8 k, simde__m128 a, simde__m128 b)
{
    ...
    a_.f32[0] = ((k & 1) ? ((simde_math_issubnormalf(a_.f32[0]) ? 0 : a_.f32[0]) *
                            simde_math_exp2f(simde_math_floorf(
                                (simde_math_issubnormalf(b_.f32[0]) ? 0 : b_.f32[0]))))
                         : src_.f32[0]);
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_maskz_scalef_ss(simde__mmask8 k, simde__m128 a, simde__m128 b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && !defined(SIMDE_BUG_GCC_95483) &&                          \
    !defined(SIMDE_BUG_GCC_105339)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_scalef_sd(simde__m128d a, simde__m128d b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE)
    ...
    a_.f64[0] =
        (simde_math_issubnormal(a_.f64[0]) ? 0 : a_.f64[0]) *
        simde_math_exp2(simde_math_floor((simde_math_issubnormal(b_.f64[0]) ? 0 : b_.f64[0])));
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_mask_scalef_sd(simde__m128d src,
                                     simde__mmask8 k,
                                     simde__m128d a,
                                     simde__m128d b)
{
...
#else
    simde__m128d_private src_ = simde__m128d_to_private(src), a_ = simde__m128d_to_private(a),
                         b_ = simde__m128d_to_private(b);

    a_.f64[0] = ((k & 1) ? ((simde_math_issubnormal(a_.f64[0]) ? 0 : a_.f64[0]) *
                            simde_math_exp2(simde_math_floor(
                                (simde_math_issubnormal(b_.f64[0]) ? 0 : b_.f64[0]))))
                         : src_.f64[0]);
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_maskz_scalef_sd(simde__mmask8 k, simde__m128d a, simde__m128d b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && !defined(SIMDE_BUG_GCC_95483) &&                          \
    !defined(SIMDE_BUG_GCC_105339)
