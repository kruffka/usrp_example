...
simde__m128i simde_mm_rolv_epi32(simde__m128i a, simde__m128i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_mask_rolv_epi32(simde__m128i src,
                                      simde__mmask8 k,
                                      simde__m128i a,
                                      simde__m128i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_maskz_rolv_epi32(simde__mmask8 k, simde__m128i a, simde__m128i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_rolv_epi32(simde__m256i a, simde__m256i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
    ...
    for (size_t i = 0; i < (sizeof(r_.m128i_private) / sizeof(r_.m128i_private[0])); i++) {
        r_.m128i_private[i].altivec_u32 =
            vec_rl(a_.m128i_private[i].altivec_u32, b_.m128i_private[i].altivec_u32);
    }
    ...
    return simde_mm256_or_si256(simde_mm256_sllv_epi32(a, count1),
                                simde_mm256_srlv_epi32(a, count2));
#endif
#endif
}
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_mask_rolv_epi32(simde__m256i src,
                                         simde__mmask8 k,
                                         simde__m256i a,
                                         simde__m256i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_maskz_rolv_epi32(simde__mmask8 k, simde__m256i a, simde__m256i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_rolv_epi32(simde__m512i a, simde__m512i b)
{
    ...
    return simde_mm512_or_si512(simde_mm512_sllv_epi32(a, count1),
                                simde_mm512_srlv_epi32(a, count2));
#endif
#endif
}
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_mask_rolv_epi32(simde__m512i src,
                                         simde__mmask16 k,
                                         simde__m512i a,
                                         simde__m512i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_maskz_rolv_epi32(simde__mmask16 k, simde__m512i a, simde__m512i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_rolv_epi64(simde__m128i a, simde__m128i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_mask_rolv_epi64(simde__m128i src,
                                      simde__mmask8 k,
                                      simde__m128i a,
                                      simde__m128i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_maskz_rolv_epi64(simde__mmask8 k, simde__m128i a, simde__m128i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_rolv_epi64(simde__m256i a, simde__m256i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
#if defined(SIMDE_POWER_ALTIVEC_P8_NATIVE)
    for (size_t i = 0; i < (sizeof(r_.m128i_private) / sizeof(r_.m128i_private[0])); i++) {
        r_.m128i_private[i].altivec_u64 =
            vec_rl(a_.m128i_private[i].altivec_u64, b_.m128i_private[i].altivec_u64);
    }
    ...
    return simde_mm256_or_si256(simde_mm256_sllv_epi64(a, count1),
                                simde_mm256_srlv_epi64(a, count2));
#endif
#endif
}
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_mask_rolv_epi64(simde__m256i src,
                                         simde__mmask8 k,
                                         simde__m256i a,
                                         simde__m256i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_maskz_rolv_epi64(simde__mmask8 k, simde__m256i a, simde__m256i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_rolv_epi64(simde__m512i a, simde__m512i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE)
    ...
    return simde_mm512_or_si512(simde_mm512_sllv_epi64(a, count1),
                                simde_mm512_srlv_epi64(a, count2));
#endif
#endif
}
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_mask_rolv_epi64(simde__m512i src,
                                         simde__mmask8 k,
                                         simde__m512i a,
                                         simde__m512i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_maskz_rolv_epi64(simde__mmask8 k, simde__m512i a, simde__m512i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE)
