...
simde__m128 simde_mm_fixupimm_ps(simde__m128 a, simde__m128 b, simde__m128i c, int imm8)
    ...
    for (size_t i = 0; i < (sizeof(r_.f32) / sizeof(r_.f32[0])); i++) {
        ...
        switch (simde_math_fpclassifyf(s_.f32[i])) {
            case SIMDE_MATH_FP_NORMAL:
                select = (s_.f32[i] < SIMDE_FLOAT32_C(0.0))    ? 6
                         : (s_.f32[i] == SIMDE_FLOAT32_C(1.0)) ? 3
                                                               : 7;
                break;
        ...
        switch (((c_.i32[i] >> (select << 2)) & 15)) {
            ...
            case 6:
                r_.f32[i] =
                    s_.f32[i] < SIMDE_FLOAT32_C(0.0) ? -SIMDE_MATH_INFINITYF : SIMDE_MATH_INFINITYF;
                break;
            case 7:
...
#else
#define simde_mm_mask_fixupimm_ps(a, k, b, c, imm8)                                                \
    simde_mm_mask_mov_ps(a, k, simde_mm_fixupimm_ps(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm_maskz_fixupimm_ps(k, a, b, c, imm8)                                               \
    simde_mm_maskz_mov_ps(k, simde_mm_fixupimm_ps(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256 simde_mm256_fixupimm_ps(simde__m256 a, simde__m256 b, simde__m256i c, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
{
    HEDLEY_STATIC_CAST(void, imm8);
...
#else
#define simde_mm256_mask_fixupimm_ps(a, k, b, c, imm8)                                             \
    simde_mm256_mask_mov_ps(a, k, simde_mm256_fixupimm_ps(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm256_maskz_fixupimm_ps(k, a, b, c, imm8)                                            \
    simde_mm256_maskz_mov_ps(k, simde_mm256_fixupimm_ps(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512 simde_mm512_fixupimm_ps(simde__m512 a, simde__m512 b, simde__m512i c, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
{
    HEDLEY_STATIC_CAST(void, imm8);
...
#else
#define simde_mm512_mask_fixupimm_ps(a, k, b, c, imm8)                                             \
    simde_mm512_mask_mov_ps(a, k, simde_mm512_fixupimm_ps(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm512_maskz_fixupimm_ps(k, a, b, c, imm8)                                            \
    simde_mm512_maskz_mov_ps(k, simde_mm512_fixupimm_ps(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_fixupimm_ss(simde__m128 a, simde__m128 b, simde__m128i c, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
{
    HEDLEY_STATIC_CAST(void, imm8);
    ...
    switch (simde_math_fpclassifyf(s_.f32[0])) {
        case SIMDE_MATH_FP_NORMAL:
            select = (s_.f32[0] < SIMDE_FLOAT32_C(0.0))    ? 6
                     : (s_.f32[0] == SIMDE_FLOAT32_C(1.0)) ? 3
                                                           : 7;
            break;
        case SIMDE_MATH_FP_ZERO:
            select = 2;
    ...
    switch (((c_.i32[0] >> (select << 2)) & 15)) {
        ...
        case 6:
            b_.f32[0] =
                s_.f32[0] < SIMDE_FLOAT32_C(0.0) ? -SIMDE_MATH_INFINITYF : SIMDE_MATH_INFINITYF;
            break;
        case 7:
...
#else
#define simde_mm_mask_fixupimm_ss(a, k, b, c, imm8)                                                \
    simde_mm_mask_mov_ps(a, ((k) | 14), simde_mm_fixupimm_ss(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm_maskz_fixupimm_ss(k, a, b, c, imm8)                                               \
    simde_mm_maskz_mov_ps(((k) | 14), simde_mm_fixupimm_ss(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_fixupimm_pd(simde__m128d a, simde__m128d b, simde__m128i c, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
{
    HEDLEY_STATIC_CAST(void, imm8);
    ...
    for (size_t i = 0; i < (sizeof(r_.f64) / sizeof(r_.f64[0])); i++) {
        ...
        switch (simde_math_fpclassify(s_.f64[i])) {
            case SIMDE_MATH_FP_NORMAL:
                select = (s_.f64[i] < SIMDE_FLOAT64_C(0.0))    ? 6
                         : (s_.f64[i] == SIMDE_FLOAT64_C(1.0)) ? 3
                                                               : 7;
                break;
            case SIMDE_MATH_FP_ZERO:
                select = 2;
        ...
        switch (((c_.i64[i] >> (select << 2)) & 15)) {
            ...
            case 6:
                r_.f64[i] =
                    s_.f64[i] < SIMDE_FLOAT64_C(0.0) ? -SIMDE_MATH_INFINITY : SIMDE_MATH_INFINITY;
                break;
            case 7:
...
#else
#define simde_mm_mask_fixupimm_pd(a, k, b, c, imm8)                                                \
    simde_mm_mask_mov_pd(a, k, simde_mm_fixupimm_pd(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm_maskz_fixupimm_pd(k, a, b, c, imm8)                                               \
    simde_mm_maskz_mov_pd(k, simde_mm_fixupimm_pd(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256d simde_mm256_fixupimm_pd(simde__m256d a, simde__m256d b, simde__m256i c, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
{
    HEDLEY_STATIC_CAST(void, imm8);
...
#else
#define simde_mm256_mask_fixupimm_pd(a, k, b, c, imm8)                                             \
    simde_mm256_mask_mov_pd(a, k, simde_mm256_fixupimm_pd(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm256_maskz_fixupimm_pd(k, a, b, c, imm8)                                            \
    simde_mm256_maskz_mov_pd(k, simde_mm256_fixupimm_pd(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512d simde_mm512_fixupimm_pd(simde__m512d a, simde__m512d b, simde__m512i c, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
{
    HEDLEY_STATIC_CAST(void, imm8);
...
#else
#define simde_mm512_mask_fixupimm_pd(a, k, b, c, imm8)                                             \
    simde_mm512_mask_mov_pd(a, k, simde_mm512_fixupimm_pd(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm512_maskz_fixupimm_pd(k, a, b, c, imm8)                                            \
    simde_mm512_maskz_mov_pd(k, simde_mm512_fixupimm_pd(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_fixupimm_sd(simde__m128d a, simde__m128d b, simde__m128i c, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
{
    HEDLEY_STATIC_CAST(void, imm8);
    ...
    switch (simde_math_fpclassify(s_.f64[0])) {
        case SIMDE_MATH_FP_NORMAL:
            select = (s_.f64[0] < SIMDE_FLOAT64_C(0.0))    ? 6
                     : (s_.f64[0] == SIMDE_FLOAT64_C(1.0)) ? 3
                                                           : 7;
            break;
        case SIMDE_MATH_FP_ZERO:
            select = 2;
    ...
    switch (((c_.i64[0] >> (select << 2)) & 15)) {
        ...
        case 6:
            b_.f64[0] =
                s_.f64[0] < SIMDE_FLOAT64_C(0.0) ? -SIMDE_MATH_INFINITY : SIMDE_MATH_INFINITY;
            break;
        case 7:
...
#else
#define simde_mm_mask_fixupimm_sd(a, k, b, c, imm8)                                                \
    simde_mm_mask_mov_pd(a, ((k) | 2), simde_mm_fixupimm_sd(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm_maskz_fixupimm_sd(k, a, b, c, imm8)                                               \
    simde_mm_maskz_mov_pd(((k) | 2), simde_mm_fixupimm_sd(a, b, c, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
