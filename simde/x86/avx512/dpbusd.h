...
simde__m128i simde_mm_dpbusd_epi32(simde__m128i src, simde__m128i a, simde__m128i b)
{
    ...
    src_.i32 += (HEDLEY_REINTERPRET_CAST(__typeof__(a_.i32), r1_[0].u32) * r2_[0].i32) +
    ...
    for (size_t i = 0; i < (sizeof(a_.u8) / sizeof(a_.u8[0])); i++) {
        src_.i32[i / 4] +=
            HEDLEY_STATIC_CAST(uint16_t, a_.u8[i]) * HEDLEY_STATIC_CAST(int16_t, b_.i8[i]);
    }
#endif
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_mask_dpbusd_epi32(simde__m128i src,
                                        simde__mmask8 k,
                                        simde__m128i a,
                                        simde__m128i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_maskz_dpbusd_epi32(simde__mmask8 k,
                                         simde__m128i src,
                                         simde__m128i a,
                                         simde__m128i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_dpbusd_epi32(simde__m256i src, simde__m256i a, simde__m256i b)
{
#if defined(SIMDE_X86_AVX512VL_NATIVE) && defined(SIMDE_X86_AVX512VNNI_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_mask_dpbusd_epi32(simde__m256i src,
                                           simde__mmask8 k,
                                           simde__m256i a,
                                           simde__m256i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_maskz_dpbusd_epi32(simde__mmask8 k,
                                            simde__m256i src,
                                            simde__m256i a,
                                            simde__m256i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_dpbusd_epi32(simde__m512i src, simde__m512i a, simde__m512i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_mask_dpbusd_epi32(simde__m512i src,
                                           simde__mmask16 k,
                                           simde__m512i a,
                                           simde__m512i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_maskz_dpbusd_epi32(simde__mmask16 k,
                                            simde__m512i src,
                                            simde__m512i a,
                                            simde__m512i b)
{
