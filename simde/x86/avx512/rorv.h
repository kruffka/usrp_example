...
simde__m128i simde_mm_rorv_epi32(simde__m128i a, simde__m128i b)
{
    ...
    r_.altivec_i32 =
        vec_rl(a_.altivec_i32,
               vec_sub(vec_splats(HEDLEY_STATIC_CAST(unsigned int, 32)), b_.altivec_u32));
    return simde__m128i_from_private(r_);
#else
    simde__m128i count1 = simde_mm_and_si128(b, simde_mm_set1_epi32(31)),
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_mask_rorv_epi32(simde__m128i src,
                                      simde__mmask8 k,
                                      simde__m128i a,
                                      simde__m128i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_maskz_rorv_epi32(simde__mmask8 k, simde__m128i a, simde__m128i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_rorv_epi32(simde__m256i a, simde__m256i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
    ...
    for (size_t i = 0; i < (sizeof(r_.m128i_private) / sizeof(r_.m128i_private[0])); i++) {
        r_.m128i_private[i].altivec_i32 =
            vec_rl(a_.m128i_private[i].altivec_i32,
                   vec_sub(vec_splats(HEDLEY_STATIC_CAST(unsigned int, 32)),
                           b_.m128i_private[i].altivec_u32));
    }
    ...
    return simde__m256i_from_private(r_);
#else
    simde__m256i count1 = simde_mm256_and_si256(b, simde_mm256_set1_epi32(31)),
                 count2 = simde_mm256_sub_epi32(simde_mm256_set1_epi32(32), count1);
    return simde_mm256_or_si256(simde_mm256_srlv_epi32(a, count1),
                                simde_mm256_sllv_epi32(a, count2));
#endif
}
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_mask_rorv_epi32(simde__m256i src,
                                         simde__mmask8 k,
                                         simde__m256i a,
                                         simde__m256i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_maskz_rorv_epi32(simde__mmask8 k, simde__m256i a, simde__m256i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_rorv_epi32(simde__m512i a, simde__m512i b)
{
    ...
    return simde__m512i_from_private(r_);
#else
    simde__m512i count1 = simde_mm512_and_si512(b, simde_mm512_set1_epi32(31)),
                 count2 = simde_mm512_sub_epi32(simde_mm512_set1_epi32(32), count1);
    return simde_mm512_or_si512(simde_mm512_srlv_epi32(a, count1),
                                simde_mm512_sllv_epi32(a, count2));
#endif
}
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_mask_rorv_epi32(simde__m512i src,
                                         simde__mmask16 k,
                                         simde__m512i a,
                                         simde__m512i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_maskz_rorv_epi32(simde__mmask16 k, simde__m512i a, simde__m512i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_rorv_epi64(simde__m128i a, simde__m128i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
    ...
    r_.altivec_i64 =
        vec_rl(a_.altivec_i64,
               vec_sub(vec_splats(HEDLEY_STATIC_CAST(unsigned long long, 64)), b_.altivec_u64));
    return simde__m128i_from_private(r_);
#else
    simde__m128i count1 = simde_mm_and_si128(b, simde_mm_set1_epi64x(63)),
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_mask_rorv_epi64(simde__m128i src,
                                      simde__mmask8 k,
                                      simde__m128i a,
                                      simde__m128i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_maskz_rorv_epi64(simde__mmask8 k, simde__m128i a, simde__m128i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_rorv_epi64(simde__m256i a, simde__m256i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
    ...
    for (size_t i = 0; i < (sizeof(r_.m128i_private) / sizeof(r_.m128i_private[0])); i++) {
        r_.m128i_private[i].altivec_i64 =
            vec_rl(a_.m128i_private[i].altivec_i64,
                   vec_sub(vec_splats(HEDLEY_STATIC_CAST(unsigned long long, 64)),
    ...
    return simde__m256i_from_private(r_);
#else
    simde__m256i count1 = simde_mm256_and_si256(b, simde_mm256_set1_epi64x(63)),
                 count2 = simde_mm256_sub_epi64(simde_mm256_set1_epi64x(64), count1);
    return simde_mm256_or_si256(simde_mm256_srlv_epi64(a, count1),
                                simde_mm256_sllv_epi64(a, count2));
#endif
}
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_mask_rorv_epi64(simde__m256i src,
                                         simde__mmask8 k,
                                         simde__m256i a,
                                         simde__m256i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_maskz_rorv_epi64(simde__mmask8 k, simde__m256i a, simde__m256i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_rorv_epi64(simde__m512i a, simde__m512i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE)
    ...
    return simde__m512i_from_private(r_);
#else
    simde__m512i count1 = simde_mm512_and_si512(b, simde_mm512_set1_epi64(63)),
                 count2 = simde_mm512_sub_epi64(simde_mm512_set1_epi64(64), count1);
    return simde_mm512_or_si512(simde_mm512_srlv_epi64(a, count1),
                                simde_mm512_sllv_epi64(a, count2));
#endif
}
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_mask_rorv_epi64(simde__m512i src,
                                         simde__mmask8 k,
                                         simde__m512i a,
                                         simde__m512i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_maskz_rorv_epi64(simde__mmask8 k, simde__m512i a, simde__m512i b)
{
#if defined(SIMDE_X86_AVX512F_NATIVE)
