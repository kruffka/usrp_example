...
#define simde_mm512_fixupimm_round_ps(a, b, c, imm8, sae)                                          \
    _mm512_fixupimm_round_ps(a, b, c, imm8, sae)
...
#define simde_mm512_fixupimm_round_ps(a, b, c, imm8, sae)                                          \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm512_fixupimm_round_ps_x =                                                  \
                feholdexcept(&simde_mm512_fixupimm_round_ps_envp);                                 \
...
simde__m512 simde_mm512_fixupimm_round_ps(simde__m512 a,
                                          simde__m512 b,
                                          simde__m512i c,
                                          int imm8,
...
#define _mm512_fixupimm_round_ps(a, b, c, imm8, sae)                                               \
    simde_mm512_fixupimm_round_ps(a, b, c, imm8, sae)
#endif

#if defined(SIMDE_X86_AVX512F_NATIVE)
#define simde_mm512_mask_fixupimm_round_ps(a, k, b, c, imm8, sae)                                  \
    _mm512_mask_fixupimm_round_ps(a, k, b, c, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm512_mask_fixupimm_round_ps(a, k, b, c, imm8, sae)                                  \
    simde_mm512_mask_fixupimm_ps(a, k, b, c, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm512_mask_fixupimm_round_ps(a, k, b, c, imm8, sae)                                  \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm512_mask_fixupimm_round_ps_x =                                             \
                feholdexcept(&simde_mm512_mask_fixupimm_round_ps_envp);                            \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512 simde_mm512_mask_fixupimm_round_ps(simde__m512 a,
                                               simde__mmask16 k,
                                               simde__m512 b,
                                               simde__m512i c,
                                               int imm8,
...
#define _mm512_mask_fixupimm_round_ps(a, k, b, c, imm8, sae)                                       \
    simde_mm512_mask_fixupimm_round_ps(a, k, b, c, imm8, sae)
#endif

#if defined(SIMDE_X86_AVX512F_NATIVE)
#define simde_mm512_maskz_fixupimm_round_ps(k, a, b, c, imm8, sae)                                 \
    _mm512_maskz_fixupimm_round_ps(k, a, b, c, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm512_maskz_fixupimm_round_ps(k, a, b, c, imm8, sae)                                 \
    simde_mm512_maskz_fixupimm_ps(k, a, b, c, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm512_maskz_fixupimm_round_ps(k, a, b, c, imm8, sae)                                 \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm512_maskz_fixupimm_round_ps_x =                                            \
                feholdexcept(&simde_mm512_maskz_fixupimm_round_ps_envp);                           \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512 simde_mm512_maskz_fixupimm_round_ps(simde__mmask16 k,
                                                simde__m512 a,
                                                simde__m512 b,
                                                simde__m512i c,
                                                int imm8,
...
#define _mm512_maskz_fixupimm_round_ps(k, a, b, c, imm8, sae)                                      \
    simde_mm512_maskz_fixupimm_round_ps(k, a, b, c, imm8, sae)
#endif

#if defined(SIMDE_X86_AVX512F_NATIVE)
#define simde_mm512_fixupimm_round_pd(a, b, c, imm8, sae)                                          \
    _mm512_fixupimm_round_pd(a, b, c, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
...
#define simde_mm512_fixupimm_round_pd(a, b, c, imm8, sae)                                          \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm512_fixupimm_round_pd_x =                                                  \
                feholdexcept(&simde_mm512_fixupimm_round_pd_envp);                                 \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512d simde_mm512_fixupimm_round_pd(simde__m512d a,
                                           simde__m512d b,
                                           simde__m512i c,
                                           int imm8,
                                           int sae) SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
...
#define _mm512_fixupimm_round_pd(a, b, c, imm8, sae)                                               \
    simde_mm512_fixupimm_round_pd(a, b, c, imm8, sae)
#endif

#if defined(SIMDE_X86_AVX512F_NATIVE)
#define simde_mm512_mask_fixupimm_round_pd(a, k, b, c, imm8, sae)                                  \
    _mm512_mask_fixupimm_round_pd(a, k, b, c, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm512_mask_fixupimm_round_pd(a, k, b, c, imm8, sae)                                  \
    simde_mm512_mask_fixupimm_pd(a, k, b, c, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm512_mask_fixupimm_round_pd(a, k, b, c, imm8, sae)                                  \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm512_mask_fixupimm_round_pd_x =                                             \
                feholdexcept(&simde_mm512_mask_fixupimm_round_pd_envp);                            \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512d simde_mm512_mask_fixupimm_round_pd(simde__m512d a,
                                                simde__mmask8 k,
                                                simde__m512d b,
                                                simde__m512i c,
                                                int imm8,
...
#define _mm512_mask_fixupimm_round_pd(a, k, b, c, imm8, sae)                                       \
    simde_mm512_mask_fixupimm_round_pd(a, k, b, c, imm8, sae)
#endif

#if defined(SIMDE_X86_AVX512F_NATIVE)
#define simde_mm512_maskz_fixupimm_round_pd(k, a, b, c, imm8, sae)                                 \
    _mm512_maskz_fixupimm_round_pd(k, a, b, c, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm512_maskz_fixupimm_round_pd(k, a, b, c, imm8, sae)                                 \
    simde_mm512_maskz_fixupimm_pd(k, a, b, c, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm512_maskz_fixupimm_round_pd(k, a, b, c, imm8, sae)                                 \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512d simde_mm512_maskz_fixupimm_round_pd(simde__mmask8 k,
                                                 simde__m512d a,
                                                 simde__m512d b,
                                                 simde__m512i c,
                                                 int imm8,
...
#define _mm512_maskz_fixupimm_round_pd(k, a, b, c, imm8, sae)                                      \
    simde_mm512_maskz_fixupimm_round_pd(k, a, b, c, imm8, sae)
#endif
...
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_fixupimm_round_ss(a, b, c, imm8, sae)                                             \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_fixupimm_round_ss(simde__m128 a,
                                       simde__m128 b,
                                       simde__m128i c,
                                       int imm8,
...
#if defined(SIMDE_X86_AVX512F_NATIVE)
#define simde_mm_mask_fixupimm_round_ss(a, k, b, c, imm8, sae)                                     \
    _mm_mask_fixupimm_round_ss(a, k, b, c, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm_mask_fixupimm_round_ss(a, k, b, c, imm8, sae)                                     \
    simde_mm_mask_fixupimm_ss(a, k, b, c, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_mask_fixupimm_round_ss(a, k, b, c, imm8, sae)                                     \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm_mask_fixupimm_round_ss_x =                                                \
                feholdexcept(&simde_mm_mask_fixupimm_round_ss_envp);                               \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_mask_fixupimm_round_ss(simde__m128 a,
                                            simde__mmask8 k,
                                            simde__m128 b,
                                            simde__m128i c,
                                            int imm8,
...
#define _mm_mask_fixupimm_round_ss(a, k, b, c, imm8, sae)                                          \
    simde_mm_mask_fixupimm_round_ss(a, k, b, c, imm8, sae)
#endif

#if defined(SIMDE_X86_AVX512F_NATIVE)
#define simde_mm_maskz_fixupimm_round_ss(k, a, b, c, imm8, sae)                                    \
    _mm_maskz_fixupimm_round_ss(k, a, b, c, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm_maskz_fixupimm_round_ss(k, a, b, c, imm8, sae)                                    \
    simde_mm_maskz_fixupimm_ss(k, a, b, c, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_maskz_fixupimm_round_ss(k, a, b, c, imm8, sae)                                    \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm_maskz_fixupimm_round_ss_x =                                               \
                feholdexcept(&simde_mm_maskz_fixupimm_round_ss_envp);                              \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_maskz_fixupimm_round_ss(simde__mmask8 k,
                                             simde__m128 a,
                                             simde__m128 b,
                                             simde__m128i c,
                                             int imm8,
...
#define _mm_maskz_fixupimm_round_ss(k, a, b, c, imm8, sae)                                         \
    simde_mm_maskz_fixupimm_round_ss(k, a, b, c, imm8, sae)
#endif
...
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_fixupimm_round_sd(a, b, c, imm8, sae)                                             \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_fixupimm_round_sd(simde__m128d a,
                                        simde__m128d b,
                                        simde__m128i c,
                                        int imm8,
                                        int sae) SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
...
#if defined(SIMDE_X86_AVX512F_NATIVE)
#define simde_mm_mask_fixupimm_round_sd(a, k, b, c, imm8, sae)                                     \
    _mm_mask_fixupimm_round_sd(a, k, b, c, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm_mask_fixupimm_round_sd(a, k, b, c, imm8, sae)                                     \
    simde_mm_mask_fixupimm_sd(a, k, b, c, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_mask_fixupimm_round_sd(a, k, b, c, imm8, sae)                                     \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm_mask_fixupimm_round_sd_x =                                                \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_mask_fixupimm_round_sd(simde__m128d a,
                                             simde__mmask8 k,
                                             simde__m128d b,
                                             simde__m128i c,
                                             int imm8,
...
#define _mm_mask_fixupimm_round_sd(a, k, b, c, imm8, sae)                                          \
    simde_mm_mask_fixupimm_round_sd(a, k, b, c, imm8, sae)
#endif

#if defined(SIMDE_X86_AVX512F_NATIVE)
#define simde_mm_maskz_fixupimm_round_sd(k, a, b, c, imm8, sae)                                    \
    _mm_maskz_fixupimm_round_sd(k, a, b, c, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm_maskz_fixupimm_round_sd(k, a, b, c, imm8, sae)                                    \
    simde_mm_maskz_fixupimm_sd(k, a, b, c, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_maskz_fixupimm_round_sd(k, a, b, c, imm8, sae)                                    \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm_maskz_fixupimm_round_sd_x =                                               \
                feholdexcept(&simde_mm_maskz_fixupimm_round_sd_envp);                              \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_maskz_fixupimm_round_sd(simde__mmask8 k,
                                              simde__m128d a,
                                              simde__m128d b,
                                              simde__m128i c,
                                              int imm8,
...
#define _mm_maskz_fixupimm_round_sd(k, a, b, c, imm8, sae)                                         \
    simde_mm_maskz_fixupimm_round_sd(k, a, b, c, imm8, sae)
#endif
