...
#define simde_mm512_roundscale_round_ps(a, imm8, sae)                                              \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm512_roundscale_round_ps_x =                                                \
...
simde__m512 simde_mm512_roundscale_round_ps(simde__m512 a, int imm8, int sae)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15) SIMDE_REQUIRE_CONSTANT(sae)
{
    simde__m512 r;
...
#define simde_mm512_mask_roundscale_round_ps(src, k, a, imm8, sae)                                 \
    _mm512_mask_roundscale_round_ps(src, k, a, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm512_mask_roundscale_round_ps(src, k, a, imm8, sae)                                 \
    simde_mm512_mask_roundscale_ps(src, k, a, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm512_mask_roundscale_round_ps(src, k, a, imm8, sae)                                 \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm512_mask_roundscale_round_ps_x =                                           \
                feholdexcept(&simde_mm512_mask_roundscale_round_ps_envp);                          \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512 simde_mm512_mask_roundscale_round_ps(simde__m512 src,
                                                 simde__mmask8 k,
                                                 simde__m512 a,
                                                 int imm8,
                                                 int sae) SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
...
#define _mm512_mask_roundscale_round_ps(src, k, a, imm8, sae)                                      \
    simde_mm512_mask_roundscale_round_ps(src, k, a, imm8, sae)
#endif

#if defined(SIMDE_X86_AVX512F_NATIVE) && !defined(SIMDE_BUG_GCC_92035)
#define simde_mm512_maskz_roundscale_round_ps(k, a, imm8, sae)                                     \
    _mm512_maskz_roundscale_round_ps(k, a, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm512_maskz_roundscale_round_ps(k, a, imm8, sae)                                     \
    simde_mm512_maskz_roundscale_ps(k, a, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm512_maskz_roundscale_round_ps(k, a, imm8, sae)                                     \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm512_maskz_roundscale_round_ps_x =                                          \
                feholdexcept(&simde_mm512_maskz_roundscale_round_ps_envp);                         \
...
#else
#define simde_mm512_maskz_roundscale_round_ps(src, k, a, imm8, sae)                                \
    simde_mm512_maskz_roundscale_ps(k, a, imm8)
#endif
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512 simde_mm512_maskz_roundscale_round_ps(simde__mmask8 k, simde__m512 a, int imm8, int sae)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15) SIMDE_REQUIRE_CONSTANT(sae)
{
    simde__m512 r;
...
#define _mm512_maskz_roundscale_round_ps(k, a, imm8, sae)                                          \
    simde_mm512_maskz_roundscale_round_ps(k, a, imm8, sae)
#endif
...
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm512_roundscale_round_pd(a, imm8, sae)                                              \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        simde__m512d simde_mm512_roundscale_round_pd_r;                                            \
                                                                                                   \
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            fenv_t simde_mm512_roundscale_round_pd_envp;                                           \
            int simde_mm512_roundscale_round_pd_x =                                                \
                feholdexcept(&simde_mm512_roundscale_round_pd_envp);                               \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512d simde_mm512_roundscale_round_pd(simde__m512d a, int imm8, int sae)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15) SIMDE_REQUIRE_CONSTANT(sae)
{
    simde__m512d r;
...
#if defined(SIMDE_X86_AVX512F_NATIVE) && !defined(SIMDE_BUG_GCC_92035)
#define simde_mm512_mask_roundscale_round_pd(src, k, a, imm8, sae)                                 \
    _mm512_mask_roundscale_round_pd(src, k, a, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm512_mask_roundscale_round_pd(src, k, a, imm8, sae)                                 \
    simde_mm512_mask_roundscale_pd(src, k, a, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm512_mask_roundscale_round_pd(src, k, a, imm8, sae)                                 \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm512_mask_roundscale_round_pd_x =                                           \
                feholdexcept(&simde_mm512_mask_roundscale_round_pd_envp);                          \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512d simde_mm512_mask_roundscale_round_pd(simde__m512d src,
                                                  simde__mmask8 k,
                                                  simde__m512d a,
                                                  int imm8,
                                                  int sae) SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
...
#define _mm512_mask_roundscale_round_pd(src, k, a, imm8, sae)                                      \
    simde_mm512_mask_roundscale_round_pd(src, k, a, imm8, sae)
#endif

#if defined(SIMDE_X86_AVX512F_NATIVE) && !defined(SIMDE_BUG_GCC_92035)
#define simde_mm512_maskz_roundscale_round_pd(k, a, imm8, sae)                                     \
    _mm512_maskz_roundscale_round_pd(k, a, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm512_maskz_roundscale_round_pd(k, a, imm8, sae)                                     \
    simde_mm512_maskz_roundscale_pd(k, a, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm512_maskz_roundscale_round_pd(k, a, imm8, sae)                                     \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm512_maskz_roundscale_round_pd_x =                                          \
                feholdexcept(&simde_mm512_maskz_roundscale_round_pd_envp);                         \
...
#else
#define simde_mm512_maskz_roundscale_round_pd(src, k, a, imm8, sae)                                \
    simde_mm512_maskz_roundscale_pd(k, a, imm8)
#endif
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512d simde_mm512_maskz_roundscale_round_pd(simde__mmask8 k,
                                                   simde__m512d a,
                                                   int imm8,
                                                   int sae)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15) SIMDE_REQUIRE_CONSTANT(sae)
...
#define _mm512_maskz_roundscale_round_pd(k, a, imm8, sae)                                          \
    simde_mm512_maskz_roundscale_round_pd(k, a, imm8, sae)
#endif
...
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_roundscale_round_ss(a, b, imm8, sae)                                              \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_roundscale_round_ss(simde__m128 a, simde__m128 b, int imm8, int sae)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255) SIMDE_REQUIRE_CONSTANT(sae)
{
    simde__m128 r;
...
#if defined(SIMDE_X86_AVX512F_NATIVE) && !defined(SIMDE_BUG_GCC_92035)
#define simde_mm_mask_roundscale_round_ss(src, k, a, b, imm8, sae)                                 \
    _mm_mask_roundscale_round_ss(src, k, a, b, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm_mask_roundscale_round_ss(src, k, a, b, imm8, sae)                                 \
    simde_mm_mask_roundscale_ss(src, k, a, b, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_mask_roundscale_round_ss(src, k, a, b, imm8, sae)                                 \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm_mask_roundscale_round_ss_x =                                              \
                feholdexcept(&simde_mm_mask_roundscale_round_ss_envp);                             \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_mask_roundscale_round_ss(simde__m128 src,
                                              simde__mmask8 k,
                                              simde__m128 a,
                                              simde__m128 b,
                                              int imm8,
                                              int sae) SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
    SIMDE_REQUIRE_CONSTANT(sae)
{
    simde__m128 r;
...
#define _mm_mask_roundscale_round_ss(src, k, a, b, imm8, sae)                                      \
    simde_mm_mask_roundscale_round_ss(src, k, a, b, imm8, sae)
#endif

#if defined(SIMDE_X86_AVX512F_NATIVE) && !defined(SIMDE_BUG_GCC_92035)
#define simde_mm_maskz_roundscale_round_ss(k, a, b, imm8, sae)                                     \
    _mm_maskz_roundscale_round_ss(k, a, b, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm_maskz_roundscale_round_ss(k, a, b, imm8, sae)                                     \
    simde_mm_maskz_roundscale_ss(k, a, b, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_maskz_roundscale_round_ss(k, a, b, imm8, sae)                                     \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm_maskz_roundscale_round_ss_x =                                             \
                feholdexcept(&simde_mm_maskz_roundscale_round_ss_envp);                            \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_maskz_roundscale_round_ss(simde__mmask8 k,
                                               simde__m128 a,
                                               simde__m128 b,
                                               int imm8,
                                               int sae) SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
...
#define _mm_maskz_roundscale_round_ss(k, a, b, imm8, sae)                                          \
    simde_mm_maskz_roundscale_round_ss(k, a, b, imm8, sae)
#endif
...
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_roundscale_round_sd(a, b, imm8, sae)                                              \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_roundscale_round_sd(simde__m128d a, simde__m128d b, int imm8, int sae)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255) SIMDE_REQUIRE_CONSTANT(sae)
{
    simde__m128d r;
...
#if defined(SIMDE_X86_AVX512F_NATIVE) && !defined(SIMDE_BUG_GCC_92035)
#define simde_mm_mask_roundscale_round_sd(src, k, a, b, imm8, sae)                                 \
    _mm_mask_roundscale_round_sd(src, k, a, b, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm_mask_roundscale_round_sd(src, k, a, b, imm8, sae)                                 \
    simde_mm_mask_roundscale_sd(src, k, a, b, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_mask_roundscale_round_sd(src, k, a, b, imm8, sae)                                 \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm_mask_roundscale_round_sd_x =                                              \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_mask_roundscale_round_sd(simde__m128d src,
                                               simde__mmask8 k,
                                               simde__m128d a,
                                               simde__m128d b,
                                               int imm8,
...
#define _mm_mask_roundscale_round_sd(src, k, a, b, imm8, sae)                                      \
    simde_mm_mask_roundscale_round_sd(src, k, a, b, imm8, sae)
#endif

#if defined(SIMDE_X86_AVX512F_NATIVE) && !defined(SIMDE_BUG_GCC_92035)
#define simde_mm_maskz_roundscale_round_sd(k, a, b, imm8, sae)                                     \
    _mm_maskz_roundscale_round_sd(k, a, b, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm_maskz_roundscale_round_sd(k, a, b, imm8, sae)                                     \
    simde_mm_maskz_roundscale_sd(k, a, b, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_maskz_roundscale_round_sd(k, a, b, imm8, sae)                                     \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm_maskz_roundscale_round_sd_x =                                             \
                feholdexcept(&simde_mm_maskz_roundscale_round_sd_envp);                            \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_maskz_roundscale_round_sd(simde__mmask8 k,
                                                simde__m128d a,
                                                simde__m128d b,
                                                int imm8,
                                                int sae) SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
...
#define _mm_maskz_roundscale_round_sd(k, a, b, imm8, sae)                                          \
    simde_mm_maskz_roundscale_round_sd(k, a, b, imm8, sae)
#endif
