...
#define simde_x_mm512_round_ps(a, rounding)                                                        \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        simde__m512_private simde_x_mm512_round_ps_r_,                                             \
            simde_x_mm512_round_ps_a_ = simde__m512_to_private(a);                                 \
                                                                                                   \
        for (size_t simde_x_mm512_round_ps_i = 0;                                                  \
             simde_x_mm512_round_ps_i <                                                            \
             (sizeof(simde_x_mm512_round_ps_r_.m256) / sizeof(simde_x_mm512_round_ps_r_.m256[0])); \
             simde_x_mm512_round_ps_i++) {                                                         \
            simde_x_mm512_round_ps_r_.m256[simde_x_mm512_round_ps_i] =                             \
                simde_mm256_round_ps(simde_x_mm512_round_ps_a_.m256[simde_x_mm512_round_ps_i],     \
                                     rounding);                                                    \
        }                                                                                          \
                                                                                                   \
...
simde__m512 simde_x_mm512_round_ps(simde__m512 a, int rounding)
    ...
    switch (rounding & ~SIMDE_MM_FROUND_NO_EXC) {
        case SIMDE_MM_FROUND_CUR_DIRECTION:
            ...
            for (size_t i = 0; i < (sizeof(r_.m128_private) / sizeof(r_.m128_private[0])); i++) {
                r_.m128_private[i].altivec_f32 =
                    HEDLEY_REINTERPRET_CAST(SIMDE_POWER_ALTIVEC_VECTOR(float),
                                            vec_round(a_.m128_private[i].altivec_f32));
            }
        ...
        case SIMDE_MM_FROUND_TO_NEAREST_INT:
            ...
            for (size_t i = 0; i < (sizeof(r_.m128_private) / sizeof(r_.m128_private[0])); i++) {
                r_.m128_private[i].altivec_f32 =
                    HEDLEY_REINTERPRET_CAST(SIMDE_POWER_ALTIVEC_VECTOR(float),
                                            vec_rint(a_.m128_private[i].altivec_f32));
            }
        ...
        case SIMDE_MM_FROUND_TO_NEG_INF:
            ...
            for (size_t i = 0; i < (sizeof(r_.m128_private) / sizeof(r_.m128_private[0])); i++) {
                r_.m128_private[i].altivec_f32 =
                    HEDLEY_REINTERPRET_CAST(SIMDE_POWER_ALTIVEC_VECTOR(float),
                                            vec_floor(a_.m128_private[i].altivec_f32));
            }
#elif defined(SIMDE_ARM_NEON_A32V8_NATIVE)
            for (size_t i = 0; i < (sizeof(r_.m128_private) / sizeof(r_.m128_private[0])); i++) {
        ...
        case SIMDE_MM_FROUND_TO_POS_INF:
            ...
            for (size_t i = 0; i < (sizeof(r_.m128_private) / sizeof(r_.m128_private[0])); i++) {
                r_.m128_private[i].altivec_f32 =
                    HEDLEY_REINTERPRET_CAST(SIMDE_POWER_ALTIVEC_VECTOR(float),
                                            vec_ceil(a_.m128_private[i].altivec_f32));
            }
#elif defined(SIMDE_ARM_NEON_A32V8_NATIVE)
            for (size_t i = 0; i < (sizeof(r_.m128_private) / sizeof(r_.m128_private[0])); i++) {
        ...
        case SIMDE_MM_FROUND_TO_ZERO:
            ...
            for (size_t i = 0; i < (sizeof(r_.m128_private) / sizeof(r_.m128_private[0])); i++) {
                r_.m128_private[i].altivec_f32 =
                    HEDLEY_REINTERPRET_CAST(SIMDE_POWER_ALTIVEC_VECTOR(float),
                                            vec_trunc(a_.m128_private[i].altivec_f32));
            }
#elif defined(SIMDE_ARM_NEON_A32V8_NATIVE)
            for (size_t i = 0; i < (sizeof(r_.m128_private) / sizeof(r_.m128_private[0])); i++) {
...
#if SIMDE_NATURAL_VECTOR_SIZE_LE(256) && defined(SIMDE_STATEMENT_EXPR_)
#define simde_x_mm512_round_pd(a, rounding)                                                        \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        simde__m512d_private simde_x_mm512_round_pd_r_,                                            \
            simde_x_mm512_round_pd_a_ = simde__m512d_to_private(a);                                \
                                                                                                   \
        for (size_t simde_x_mm512_round_pd_i = 0;                                                  \
             simde_x_mm512_round_pd_i < (sizeof(simde_x_mm512_round_pd_r_.m256d) /                 \
                                         sizeof(simde_x_mm512_round_pd_r_.m256d[0]));              \
             simde_x_mm512_round_pd_i++) {                                                         \
            simde_x_mm512_round_pd_r_.m256d[simde_x_mm512_round_pd_i] =                            \
                simde_mm256_round_pd(simde_x_mm512_round_pd_a_.m256d[simde_x_mm512_round_pd_i],    \
                                     rounding);                                                    \
        }                                                                                          \
                                                                                                   \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512d simde_x_mm512_round_pd(simde__m512d a, int rounding)
    SIMDE_REQUIRE_CONSTANT_RANGE(rounding, 0, 15)
{
    ...
    switch (rounding & ~SIMDE_MM_FROUND_NO_EXC) {
        case SIMDE_MM_FROUND_CUR_DIRECTION:
            ...
            for (size_t i = 0; i < (sizeof(r_.m128d_private) / sizeof(r_.m128d_private[0])); i++) {
                r_.m128d_private[i].altivec_f64 =
                    HEDLEY_REINTERPRET_CAST(SIMDE_POWER_ALTIVEC_VECTOR(double),
                                            vec_round(a_.m128d_private[i].altivec_f64));
            }
        ...
        case SIMDE_MM_FROUND_TO_NEG_INF:
            ...
            for (size_t i = 0; i < (sizeof(r_.m128d_private) / sizeof(r_.m128d_private[0])); i++) {
                r_.m128d_private[i].altivec_f64 =
                    HEDLEY_REINTERPRET_CAST(SIMDE_POWER_ALTIVEC_VECTOR(double),
                                            vec_floor(a_.m128d_private[i].altivec_f64));
            }
#elif defined(SIMDE_ARM_NEON_A64V8_NATIVE)
            for (size_t i = 0; i < (sizeof(r_.m128d_private) / sizeof(r_.m128d_private[0])); i++) {
        ...
        case SIMDE_MM_FROUND_TO_POS_INF:
            ...
            for (size_t i = 0; i < (sizeof(r_.m128d_private) / sizeof(r_.m128d_private[0])); i++) {
                r_.m128d_private[i].altivec_f64 =
                    HEDLEY_REINTERPRET_CAST(SIMDE_POWER_ALTIVEC_VECTOR(double),
                                            vec_ceil(a_.m128d_private[i].altivec_f64));
            }
#elif defined(SIMDE_ARM_NEON_A64V8_NATIVE)
            for (size_t i = 0; i < (sizeof(r_.m128d_private) / sizeof(r_.m128d_private[0])); i++) {
        ...
        case SIMDE_MM_FROUND_TO_ZERO:
            ...
            for (size_t i = 0; i < (sizeof(r_.m128d_private) / sizeof(r_.m128d_private[0])); i++) {
                r_.m128d_private[i].altivec_f64 =
                    HEDLEY_REINTERPRET_CAST(SIMDE_POWER_ALTIVEC_VECTOR(double),
                                            vec_trunc(a_.m128d_private[i].altivec_f64));
            }
#elif defined(SIMDE_ARM_NEON_A64V8_NATIVE)
            for (size_t i = 0; i < (sizeof(r_.m128d_private) / sizeof(r_.m128d_private[0])); i++) {
