...
simde__m128i simde_mm_dpwssds_epi32(simde__m128i src, simde__m128i a, simde__m128i b)
{
    ...
    simde__m128i_private r1_[2], r2_[2];

    a_.i16 = SIMDE_SHUFFLE_VECTOR_(16, 16, a_.i16, a_.i16, 0, 2, 4, 6, 1, 3, 5, 7);
    b_.i16 = SIMDE_SHUFFLE_VECTOR_(16, 16, b_.i16, b_.i16, 0, 2, 4, 6, 1, 3, 5, 7);
    ...
    uint32_t au SIMDE_VECTOR(16) =
        HEDLEY_REINTERPRET_CAST(__typeof__(src_.u32),
                                ((r1_[0].i32 * r2_[0].i32) + (r1_[1].i32 * r2_[1].i32)));
    ...
    for (size_t i = 0; i < (sizeof(a_.i16) / sizeof(a_.i16[0]) / 2); i++) {
        src_.i32[i] = simde_math_adds_i32(src_.i32[i],
                                          HEDLEY_STATIC_CAST(int32_t, a_.i16[(2 * i)]) *
                                                  HEDLEY_STATIC_CAST(int32_t, b_.i16[(2 * i)]) +
                                              HEDLEY_STATIC_CAST(int32_t, a_.i16[(2 * i) + 1]) *
                                                  HEDLEY_STATIC_CAST(int32_t, b_.i16[(2 * i) + 1]));
    }
#endif
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_mask_dpwssds_epi32(simde__m128i src,
                                         simde__mmask8 k,
                                         simde__m128i a,
                                         simde__m128i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_maskz_dpwssds_epi32(simde__mmask8 k,
                                          simde__m128i src,
                                          simde__m128i a,
                                          simde__m128i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_dpwssds_epi32(simde__m256i src, simde__m256i a, simde__m256i b)
{
#if defined(SIMDE_X86_AVX512VNNI_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
    ...
    simde__m256i_private r1_[2], r2_[2];

    a_.i16 = SIMDE_SHUFFLE_VECTOR_(16,
                                   32,
                                   a_.i16,
                                   a_.i16,
                                   0,
                                   ...
                                   13,
                                   15);
    b_.i16 = SIMDE_SHUFFLE_VECTOR_(16,
                                   32,
                                   b_.i16,
                                   b_.i16,
                                   0,
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_mask_dpwssds_epi32(simde__m256i src,
                                            simde__mmask8 k,
                                            simde__m256i a,
                                            simde__m256i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_maskz_dpwssds_epi32(simde__mmask8 k,
                                             simde__m256i src,
                                             simde__m256i a,
                                             simde__m256i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_dpwssds_epi32(simde__m512i src, simde__m512i a, simde__m512i b)
{
    ...
    simde__m512i_private r1_[2], r2_[2];
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_mask_dpwssds_epi32(simde__m512i src,
                                            simde__mmask16 k,
                                            simde__m512i a,
                                            simde__m512i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_maskz_dpwssds_epi32(simde__mmask16 k,
                                             simde__m512i src,
                                             simde__m512i a,
                                             simde__m512i b)
{
