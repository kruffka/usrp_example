...
simde__m128 simde_mm_range_ps(simde__m128 a, simde__m128 b, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
{
    ...
    switch (imm8 & 3) {
        ...
        case 1:
            ...
            break;
        case 2:
            r = simde_x_mm_select_ps(b,
                                     a,
                                     simde_mm_cmple_ps(simde_x_mm_abs_ps(a), simde_x_mm_abs_ps(b)));
            break;
        case 3:
            r = simde_x_mm_select_ps(b,
                                     a,
                                     simde_mm_cmpge_ps(simde_x_mm_abs_ps(a), simde_x_mm_abs_ps(b)));
            break;
        default:
            break;
    }
...
#else
#define simde_mm_mask_range_ps(src, k, a, b, imm8)                                                 \
    simde_mm_mask_mov_ps(src, k, simde_mm_range_ps(a, b, imm8))
#endif
#if defined(SIMDE_X86_AVX512DQ_ENABLE_NATIVE_ALIASES) &&                                           \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm_maskz_range_ps(k, a, b, imm8)                                                     \
    simde_mm_maskz_mov_ps(k, simde_mm_range_ps(a, b, imm8))
#endif
#if defined(SIMDE_X86_AVX512DQ_ENABLE_NATIVE_ALIASES) &&                                           \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256 simde_mm256_range_ps(simde__m256 a, simde__m256 b, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
{
    simde__m256 r;
    ...
    switch (imm8 & 3) {
        ...
        case 1:
            ...
            break;
        case 2:
            r = simde_x_mm256_select_ps(b,
                                        a,
                                        simde_mm256_cmp_ps(simde_x_mm256_abs_ps(a),
                                                           simde_x_mm256_abs_ps(b),
                                                           SIMDE_CMP_LE_OQ));
            break;
        case 3:
            r = simde_x_mm256_select_ps(b,
...
#define simde_mm256_range_ps(a, b, imm8)                                                           \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        simde__m256_private simde_mm256_range_ps_r_,                                               \
            simde_mm256_range_ps_a_ = simde__m256_to_private(a),                                   \
            simde_mm256_range_ps_b_ = simde__m256_to_private(b);                                   \
                                                                                                   \
        for (size_t simde_mm256_range_ps_i = 0;                                                    \
             simde_mm256_range_ps_i <                                                              \
             (sizeof(simde_mm256_range_ps_r_.m128) / sizeof(simde_mm256_range_ps_r_.m128[0]));     \
             simde_mm256_range_ps_i++) {                                                           \
            simde_mm256_range_ps_r_.m128[simde_mm256_range_ps_i] =                                 \
...
#else
#define simde_mm256_mask_range_ps(src, k, a, b, imm8)                                              \
    simde_mm256_mask_mov_ps(src, k, simde_mm256_range_ps(a, b, imm8))
#endif
#if defined(SIMDE_X86_AVX512DQ_ENABLE_NATIVE_ALIASES) &&                                           \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm256_maskz_range_ps(k, a, b, imm8)                                                  \
    simde_mm256_maskz_mov_ps(k, simde_mm256_range_ps(a, b, imm8))
#endif
#if defined(SIMDE_X86_AVX512DQ_ENABLE_NATIVE_ALIASES) &&                                           \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512 simde_mm512_range_ps(simde__m512 a, simde__m512 b, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
{
    simde__m512 r;
    ...
    switch (imm8 & 3) {
        ...
        case 1:
            ...
            break;
        case 2:
            r = simde_mm512_mask_mov_ps(b,
                                        simde_mm512_cmp_ps_mask(simde_mm512_abs_ps(a),
                                                                simde_mm512_abs_ps(b),
                                                                SIMDE_CMP_LE_OS),
                                        a);
            break;
        case 3:
            r = simde_mm512_mask_mov_ps(a,
                                        simde_mm512_cmp_ps_mask(simde_mm512_abs_ps(b),
...
#elif SIMDE_NATURAL_VECTOR_SIZE_LE(128) && defined(SIMDE_STATEMENT_EXPR_)
#define simde_mm512_range_ps(a, b, imm8)                                                           \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        simde__m512_private simde_mm512_range_ps_r_,                                               \
            simde_mm512_range_ps_a_ = simde__m512_to_private(a),                                   \
            simde_mm512_range_ps_b_ = simde__m512_to_private(b);                                   \
                                                                                                   \
        for (size_t simde_mm512_range_ps_i = 0;                                                    \
             simde_mm512_range_ps_i <                                                              \
             (sizeof(simde_mm512_range_ps_r_.m128) / sizeof(simde_mm512_range_ps_r_.m128[0]));     \
             simde_mm512_range_ps_i++) {                                                           \
            simde_mm512_range_ps_r_.m128[simde_mm512_range_ps_i] =                                 \
                simde_mm_range_ps(simde_mm512_range_ps_a_.m128[simde_mm512_range_ps_i],            \
                                  simde_mm512_range_ps_b_.m128[simde_mm512_range_ps_i],            \
                                  imm8);                                                           \
        }                                                                                          \
                                                                                                   \
...
#define simde_mm512_range_ps(a, b, imm8)                                                           \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        for (size_t simde_mm512_range_ps_i = 0;                                                    \
             simde_mm512_range_ps_i <                                                              \
             (sizeof(simde_mm512_range_ps_r_.m256) / sizeof(simde_mm512_range_ps_r_.m256[0]));     \
             simde_mm512_range_ps_i++) {                                                           \
            simde_mm512_range_ps_r_.m256[simde_mm512_range_ps_i] =                                 \
                simde_mm256_range_ps(simde_mm512_range_ps_a_.m256[simde_mm512_range_ps_i],         \
                                     simde_mm512_range_ps_b_.m256[simde_mm512_range_ps_i],         \
                                     imm8);                                                        \
        }                                                                                          \
                                                                                                   \
        simde__m512_from_private(simde_mm512_range_ps_r_);                                         \
...
#else
#define simde_mm512_mask_range_ps(src, k, a, b, imm8)                                              \
    simde_mm512_mask_mov_ps(src, k, simde_mm512_range_ps(a, b, imm8))
#endif
#if defined(SIMDE_X86_AVX512DQ_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm512_maskz_range_ps(k, a, b, imm8)                                                  \
    simde_mm512_maskz_mov_ps(k, simde_mm512_range_ps(a, b, imm8))
#endif
#if defined(SIMDE_X86_AVX512DQ_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_range_pd(simde__m128d a, simde__m128d b, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
{
    simde__m128d r;
    ...
    switch (imm8 & 3) {
        ...
        case 1:
            ...
            break;
        case 2:
            r = simde_x_mm_select_pd(b,
                                     a,
                                     simde_mm_cmple_pd(simde_x_mm_abs_pd(a), simde_x_mm_abs_pd(b)));
            break;
        case 3:
            r = simde_x_mm_select_pd(b,
                                     a,
                                     simde_mm_cmpge_pd(simde_x_mm_abs_pd(a), simde_x_mm_abs_pd(b)));
            break;
        default:
            break;
    }
...
#else
#define simde_mm_mask_range_pd(src, k, a, b, imm8)                                                 \
    simde_mm_mask_mov_pd(src, k, simde_mm_range_pd(a, b, imm8))
#endif
#if defined(SIMDE_X86_AVX512DQ_ENABLE_NATIVE_ALIASES) &&                                           \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm_maskz_range_pd(k, a, b, imm8)                                                     \
    simde_mm_maskz_mov_pd(k, simde_mm_range_pd(a, b, imm8))
#endif
#if defined(SIMDE_X86_AVX512DQ_ENABLE_NATIVE_ALIASES) &&                                           \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256d simde_mm256_range_pd(simde__m256d a, simde__m256d b, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
{
    simde__m256d r;
    ...
    switch (imm8 & 3) {
        ...
        case 1:
            ...
            break;
        case 2:
            r = simde_x_mm256_select_pd(b,
                                        a,
                                        simde_mm256_cmp_pd(simde_x_mm256_abs_pd(a),
                                                           simde_x_mm256_abs_pd(b),
                                                           SIMDE_CMP_LE_OQ));
            break;
        case 3:
            r = simde_x_mm256_select_pd(b,
...
#elif SIMDE_NATURAL_VECTOR_SIZE_LE(128) && defined(SIMDE_STATEMENT_EXPR_)
#define simde_mm256_range_pd(a, b, imm8)                                                           \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        simde__m256d_private simde_mm256_range_pd_r_,                                              \
            simde_mm256_range_pd_a_ = simde__m256d_to_private(a),                                  \
            simde_mm256_range_pd_b_ = simde__m256d_to_private(b);                                  \
                                                                                                   \
        for (size_t simde_mm256_range_pd_i = 0;                                                    \
             simde_mm256_range_pd_i <                                                              \
             (sizeof(simde_mm256_range_pd_r_.m128d) / sizeof(simde_mm256_range_pd_r_.m128d[0]));   \
             simde_mm256_range_pd_i++) {                                                           \
            simde_mm256_range_pd_r_.m128d[simde_mm256_range_pd_i] =                                \
                simde_mm_range_pd(simde_mm256_range_pd_a_.m128d[simde_mm256_range_pd_i],           \
                                  simde_mm256_range_pd_b_.m128d[simde_mm256_range_pd_i],           \
                                  imm8);                                                           \
        }                                                                                          \
                                                                                                   \
...
#else
#define simde_mm256_mask_range_pd(src, k, a, b, imm8)                                              \
    simde_mm256_mask_mov_pd(src, k, simde_mm256_range_pd(a, b, imm8))
#endif
#if defined(SIMDE_X86_AVX512DQ_ENABLE_NATIVE_ALIASES) &&                                           \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm256_maskz_range_pd(k, a, b, imm8)                                                  \
    simde_mm256_maskz_mov_pd(k, simde_mm256_range_pd(a, b, imm8))
#endif
#if defined(SIMDE_X86_AVX512DQ_ENABLE_NATIVE_ALIASES) &&                                           \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512d simde_mm512_range_pd(simde__m512d a, simde__m512d b, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
{
    simde__m512d r;
    ...
    switch (imm8 & 3) {
        ...
        case 1:
            ...
            break;
        case 2:
            r = simde_mm512_mask_mov_pd(b,
                                        simde_mm512_cmp_pd_mask(simde_mm512_abs_pd(a),
                                                                simde_mm512_abs_pd(b),
                                                                SIMDE_CMP_LE_OS),
                                        a);
            break;
        case 3:
            r = simde_mm512_mask_mov_pd(a,
                                        simde_mm512_cmp_pd_mask(simde_mm512_abs_pd(b),
...
#elif SIMDE_NATURAL_VECTOR_SIZE_LE(128) && defined(SIMDE_STATEMENT_EXPR_)
#define simde_mm512_range_pd(a, b, imm8)                                                           \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        simde__m512d_private simde_mm512_range_pd_r_,                                              \
            simde_mm512_range_pd_a_ = simde__m512d_to_private(a),                                  \
            simde_mm512_range_pd_b_ = simde__m512d_to_private(b);                                  \
                                                                                                   \
        for (size_t simde_mm512_range_pd_i = 0;                                                    \
             simde_mm512_range_pd_i <                                                              \
             (sizeof(simde_mm512_range_pd_r_.m128d) / sizeof(simde_mm512_range_pd_r_.m128d[0]));   \
             simde_mm512_range_pd_i++) {                                                           \
            simde_mm512_range_pd_r_.m128d[simde_mm512_range_pd_i] =                                \
                simde_mm_range_pd(simde_mm512_range_pd_a_.m128d[simde_mm512_range_pd_i],           \
                                  simde_mm512_range_pd_b_.m128d[simde_mm512_range_pd_i],           \
                                  imm8);                                                           \
        }                                                                                          \
                                                                                                   \
...
#define simde_mm512_range_pd(a, b, imm8)                                                           \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        for (size_t simde_mm512_range_pd_i = 0;                                                    \
             simde_mm512_range_pd_i <                                                              \
             (sizeof(simde_mm512_range_pd_r_.m256d) / sizeof(simde_mm512_range_pd_r_.m256d[0]));   \
             simde_mm512_range_pd_i++) {                                                           \
            simde_mm512_range_pd_r_.m256d[simde_mm512_range_pd_i] =                                \
                simde_mm256_range_pd(simde_mm512_range_pd_a_.m256d[simde_mm512_range_pd_i],        \
                                     simde_mm512_range_pd_b_.m256d[simde_mm512_range_pd_i],        \
                                     imm8);                                                        \
        }                                                                                          \
                                                                                                   \
        simde__m512d_from_private(simde_mm512_range_pd_r_);                                        \
...
#else
#define simde_mm512_mask_range_pd(src, k, a, b, imm8)                                              \
    simde_mm512_mask_mov_pd(src, k, simde_mm512_range_pd(a, b, imm8))
#endif
#if defined(SIMDE_X86_AVX512DQ_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm512_maskz_range_pd(k, a, b, imm8)                                                  \
    simde_mm512_maskz_mov_pd(k, simde_mm512_range_pd(a, b, imm8))
#endif
#if defined(SIMDE_X86_AVX512DQ_ENABLE_NATIVE_ALIASES)
...
#define simde_x_mm_range_ss(a, b, imm8)                                                            \
    simde_mm_move_ss(                                                                              \
        a,                                                                                         \
        simde_mm_range_ps(simde_x_mm_broadcastlow_ps(a), simde_x_mm_broadcastlow_ps(b), imm8))
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_x_mm_range_ss(simde__m128 a, simde__m128 b, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
{
    simde__m128_private r_ = simde__m128_to_private(a), a_ = simde__m128_to_private(a),
    ...
    switch (imm8 & 12) {
        case 0:
            r_.f32[0] = simde_uint32_as_float32(
                (a_.u32[0] & UINT32_C(2147483648)) ^ (r_.u32[0] & UINT32_C(2147483647)));
            break;
        case 8:
...
#define simde_mm_mask_range_ss(src, k, a, b, imm8)                                                 \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        simde__m128_private simde_mm_mask_range_ss_r_ = simde__m128_to_private(a),                 \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_mask_range_ss(simde__m128 src,
                                   simde__mmask8 k,
                                   simde__m128 a,
                                   simde__m128 b,
                                   int imm8) SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
{
    simde__m128_private r_ = simde__m128_to_private(a), src_ = simde__m128_to_private(src);
...
#elif defined(SIMDE_STATEMENT_EXPR_)
#define simde_mm_maskz_range_ss(k, a, b, imm8)                                                     \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_maskz_range_ss(simde__mmask8 k, simde__m128 a, simde__m128 b, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
{
...
#elif (SIMDE_NATURAL_VECTOR_SIZE > 0)
#define simde_x_mm_range_sd(a, b, imm8)                                                            \
    simde_mm_move_sd(                                                                              \
        a,                                                                                         \
        simde_mm_range_pd(simde_x_mm_broadcastlow_pd(a), simde_x_mm_broadcastlow_pd(b), imm8))
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_x_mm_range_sd(simde__m128d a, simde__m128d b, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
{
    simde__m128d_private r_ = simde__m128d_to_private(a), a_ = simde__m128d_to_private(a),
    ...
    switch (imm8 & 12) {
        case 0:
            r_.f64[0] = simde_uint64_as_float64((a_.u64[0] & UINT64_C(9223372036854775808)) ^
                                                (r_.u64[0] & UINT64_C(9223372036854775807)));
            break;
        case 8:
...
#elif defined(SIMDE_STATEMENT_EXPR_)
#define simde_mm_mask_range_sd(src, k, a, b, imm8)                                                 \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        simde__m128d_private simde_mm_mask_range_sd_r_ = simde__m128d_to_private(a),               \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_mask_range_sd(simde__m128d src,
                                    simde__mmask8 k,
                                    simde__m128d a,
                                    simde__m128d b,
                                    int imm8) SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
{
    simde__m128d_private r_ = simde__m128d_to_private(a), src_ = simde__m128d_to_private(src);
...
#elif defined(SIMDE_STATEMENT_EXPR_)
#define simde_mm_maskz_range_sd(k, a, b, imm8)                                                     \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_maskz_range_sd(simde__mmask8 k, simde__m128d a, simde__m128d b, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
{
