...
#define simde_mm512_range_round_ps(a, b, imm8, sae)                                                \
...
simde__m512 simde_mm512_range_round_ps(simde__m512 a, simde__m512 b, int imm8, int sae)
...
#if defined(SIMDE_X86_AVX512DQ_NATIVE)
#define simde_mm512_mask_range_round_ps(src, k, a, b, imm8, sae)                                   \
    _mm512_mask_range_round_ps(src, k, a, b, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm512_mask_range_round_ps(src, k, a, b, imm8, sae)                                   \
    simde_mm512_mask_range_ps(src, k, a, b, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm512_mask_range_round_ps(src, k, a, b, imm8, sae)                                   \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm512_mask_range_round_ps_x =                                                \
                feholdexcept(&simde_mm512_mask_range_round_ps_envp);                               \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512 simde_mm512_mask_range_round_ps(simde__m512 src,
                                            simde__mmask16 k,
                                            simde__m512 a,
                                            simde__m512 b,
                                            int imm8,
...
#define _mm512_mask_range_round_ps(src, k, a, b, imm8)                                             \
    simde_mm512_mask_range_round_ps(src, k, a, b, imm8)
#endif

#if defined(SIMDE_X86_AVX512DQ_NATIVE)
#define simde_mm512_maskz_range_round_ps(k, a, b, imm8, sae)                                       \
    _mm512_maskz_range_round_ps(k, a, b, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm512_maskz_range_round_ps(k, a, b, imm8, sae)                                       \
    simde_mm512_maskz_range_ps(k, a, b, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm512_maskz_range_round_ps(k, a, b, imm8, sae)                                       \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm512_maskz_range_round_ps_x =                                               \
                feholdexcept(&simde_mm512_maskz_range_round_ps_envp);                              \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512 simde_mm512_maskz_range_round_ps(simde__mmask16 k,
                                             simde__m512 a,
                                             simde__m512 b,
                                             int imm8,
                                             int sae) SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
...
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm512_range_round_pd(a, b, imm8, sae)                                                \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512d simde_mm512_range_round_pd(simde__m512d a, simde__m512d b, int imm8, int sae)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15) SIMDE_REQUIRE_CONSTANT(sae)
{
    simde__m512d r;
...
#if defined(SIMDE_X86_AVX512DQ_NATIVE)
#define simde_mm512_mask_range_round_pd(src, k, a, b, imm8, sae)                                   \
    _mm512_mask_range_round_pd(src, k, a, b, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm512_mask_range_round_pd(src, k, a, b, imm8, sae)                                   \
    simde_mm512_mask_range_pd(src, k, a, b, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm512_mask_range_round_pd(src, k, a, b, imm8, sae)                                   \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm512_mask_range_round_pd_x =                                                \
                feholdexcept(&simde_mm512_mask_range_round_pd_envp);                               \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512d simde_mm512_mask_range_round_pd(simde__m512d src,
                                             simde__mmask8 k,
                                             simde__m512d a,
                                             simde__m512d b,
                                             int imm8,
...
#define _mm512_mask_range_round_pd(src, k, a, b, imm8)                                             \
    simde_mm512_mask_range_round_pd(src, k, a, b, imm8)
#endif

#if defined(SIMDE_X86_AVX512DQ_NATIVE)
#define simde_mm512_maskz_range_round_pd(k, a, b, imm8, sae)                                       \
    _mm512_maskz_range_round_pd(k, a, b, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm512_maskz_range_round_pd(k, a, b, imm8, sae)                                       \
    simde_mm512_maskz_range_pd(k, a, b, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm512_maskz_range_round_pd(k, a, b, imm8, sae)                                       \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm512_maskz_range_round_pd_x =                                               \
                feholdexcept(&simde_mm512_maskz_range_round_pd_envp);                              \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512d simde_mm512_maskz_range_round_pd(simde__mmask8 k,
                                              simde__m512d a,
                                              simde__m512d b,
                                              int imm8,
                                              int sae) SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
...
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_range_round_ss(a, b, imm8, sae)                                                   \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_range_round_ss(simde__m128 a, simde__m128 b, int imm8, int sae)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15) SIMDE_REQUIRE_CONSTANT(sae)
{
    simde__m128 r;
...
#if defined(SIMDE_X86_AVX512DQ_NATIVE)
#define simde_mm_mask_range_round_ss(src, k, a, b, imm8, sae)                                      \
    _mm_mask_range_round_ss(src, k, a, b, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm_mask_range_round_ss(src, k, a, b, imm8, sae)                                      \
    simde_mm_mask_range_ss(src, k, a, b, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_mask_range_round_ss(src, k, a, b, imm8, sae)                                      \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_mask_range_round_ss(simde__m128 src,
                                         simde__mmask8 k,
                                         simde__m128 a,
                                         simde__m128 b,
                                         int imm8,
...
#if defined(SIMDE_X86_AVX512DQ_NATIVE)
#define simde_mm_maskz_range_round_ss(k, a, b, imm8, sae)                                          \
    _mm_maskz_range_round_ss(k, a, b, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
...
#define simde_mm_maskz_range_round_ss(k, a, b, imm8, sae)                                          \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm_maskz_range_round_ss_x =                                                  \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_maskz_range_round_ss(simde__mmask8 k,
                                          simde__m128 a,
                                          simde__m128 b,
                                          int imm8,
                                          int sae) SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
...
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_range_round_sd(a, b, imm8, sae)                                                   \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_range_round_sd(simde__m128d a, simde__m128d b, int imm8, int sae)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15) SIMDE_REQUIRE_CONSTANT(sae)
{
    simde__m128d r;
...
#if defined(SIMDE_X86_AVX512DQ_NATIVE)
#define simde_mm_mask_range_round_sd(src, k, a, b, imm8, sae)                                      \
    _mm_mask_range_round_sd(src, k, a, b, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
#define simde_mm_mask_range_round_sd(src, k, a, b, imm8, sae)                                      \
    simde_mm_mask_range_sd(src, k, a, b, imm8)
#elif defined(SIMDE_STATEMENT_EXPR_)
#if defined(SIMDE_HAVE_FENV_H)
#define simde_mm_mask_range_round_sd(src, k, a, b, imm8, sae)                                      \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_mask_range_round_sd(simde__m128d src,
                                          simde__mmask8 k,
                                          simde__m128d a,
                                          simde__m128d b,
                                          int imm8,
...
#if defined(SIMDE_X86_AVX512DQ_NATIVE)
#define simde_mm_maskz_range_round_sd(k, a, b, imm8, sae)                                          \
    _mm_maskz_range_round_sd(k, a, b, imm8, sae)
#elif defined(SIMDE_FAST_EXCEPTIONS)
...
#define simde_mm_maskz_range_round_sd(k, a, b, imm8, sae)                                          \
    SIMDE_STATEMENT_EXPR_(({                                                                       \
        ...
        if (sae & SIMDE_MM_FROUND_NO_EXC) {                                                        \
            ...
            int simde_mm_maskz_range_round_sd_x =                                                  \
                feholdexcept(&simde_mm_maskz_range_round_sd_envp);                                 \
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128d simde_mm_maskz_range_round_sd(simde__mmask8 k,
                                           simde__m128d a,
                                           simde__m128d b,
                                           int imm8,
                                           int sae) SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 15)
