...
simde__m128i simde_mm_multishift_epi64_epi8(simde__m128i a, simde__m128i b)
{
    ...
    for (size_t i = 0; i < sizeof(r_.u8) / sizeof(r_.u8[0]); i++) {
        r_.u8[i] = HEDLEY_STATIC_CAST(
            uint8_t,
            (b_.u64[i / 8] >> (a_.u8[i] & 63)) | (b_.u64[i / 8] << (64 - (a_.u8[i] & 63))));
    }
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_mask_multishift_epi64_epi8(simde__m128i src,
                                                 simde__mmask16 k,
                                                 simde__m128i a,
                                                 simde__m128i b)
{
...
#define _mm_mask_multishift_epi64_epi8(src, k, a, b)                                               \
    simde_mm_mask_multishift_epi64_epi8(src, k, a, b)
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_maskz_multishift_epi64_epi8(simde__mmask16 k, simde__m128i a, simde__m128i b)
{
#if defined(SIMDE_X86_AVX512VBMI_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
#define _mm_maskz_multishift_epi64_epi8(src, k, a, b)                                              \
    simde_mm_maskz_multishift_epi64_epi8(src, k, a, b)
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_multishift_epi64_epi8(simde__m256i a, simde__m256i b)
{
#if defined(SIMDE_X86_AVX512VBMI_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_mask_multishift_epi64_epi8(simde__m256i src,
                                                    simde__mmask32 k,
                                                    simde__m256i a,
                                                    simde__m256i b)
{
...
#define _mm256_mask_multishift_epi64_epi8(src, k, a, b)                                            \
    simde_mm256_mask_multishift_epi64_epi8(src, k, a, b)
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_maskz_multishift_epi64_epi8(simde__mmask32 k,
                                                     simde__m256i a,
                                                     simde__m256i b)
{
#if defined(SIMDE_X86_AVX512VBMI_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
...
#define _mm256_maskz_multishift_epi64_epi8(src, k, a, b)                                           \
    simde_mm256_maskz_multishift_epi64_epi8(src, k, a, b)
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_multishift_epi64_epi8(simde__m512i a, simde__m512i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_mask_multishift_epi64_epi8(simde__m512i src,
                                                    simde__mmask64 k,
                                                    simde__m512i a,
                                                    simde__m512i b)
{
...
#define _mm512_mask_multishift_epi64_epi8(src, k, a, b)                                            \
    simde_mm512_mask_multishift_epi64_epi8(src, k, a, b)
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_maskz_multishift_epi64_epi8(simde__mmask64 k,
                                                     simde__m512i a,
                                                     simde__m512i b)
{
#if defined(SIMDE_X86_AVX512VBMI_NATIVE)
...
#define _mm512_maskz_multishift_epi64_epi8(src, k, a, b)                                           \
    simde_mm512_maskz_multishift_epi64_epi8(src, k, a, b)
#endif
