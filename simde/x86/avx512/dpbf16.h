...
simde__m128 simde_mm_dpbf16_ps(simde__m128 src, simde__m128bh a, simde__m128bh b)
{
    ...
    simde__m128bh_private a_ = simde__m128bh_to_private(a), b_ = simde__m128bh_to_private(b);

#if !(defined(SIMDE_ARCH_X86) && defined(HEDLEY_GCC_VERSION)) &&                                   \
    defined(SIMDE_VECTOR_SUBSCRIPT_SCALAR) && defined(SIMDE_CONVERT_VECTOR_) &&                    \
    defined(SIMDE_SHUFFLE_VECTOR_)
    uint32_t x1 SIMDE_VECTOR(32);
    uint32_t x2 SIMDE_VECTOR(32);
    simde__m128_private r1_[2], r2_[2];

    a_.u16 = SIMDE_SHUFFLE_VECTOR_(16, 16, a_.u16, a_.u16, 0, 2, 4, 6, 1, 3, 5, 7);
    b_.u16 = SIMDE_SHUFFLE_VECTOR_(16, 16, b_.u16, b_.u16, 0, 2, 4, 6, 1, 3, 5, 7);
    ...
    src_.f32 += HEDLEY_REINTERPRET_CAST(__typeof__(a_.f32), r1_[0].u32) *
                    HEDLEY_REINTERPRET_CAST(__typeof__(a_.f32), r2_[0].u32) +
                HEDLEY_REINTERPRET_CAST(__typeof__(a_.f32), r1_[1].u32) *
                    HEDLEY_REINTERPRET_CAST(__typeof__(a_.f32), r2_[1].u32);
#else
    SIMDE_VECTORIZE
    for (size_t i = 0; i < (sizeof(a_.u16) / sizeof(a_.u16[0])); i++) {
        src_.f32[i / 2] += (simde_uint32_as_float32(HEDLEY_STATIC_CAST(uint32_t, a_.u16[i]) << 16) *
                            simde_uint32_as_float32(HEDLEY_STATIC_CAST(uint32_t, b_.u16[i]) << 16));
    }
#endif
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_mask_dpbf16_ps(simde__m128 src,
                                    simde__mmask8 k,
                                    simde__m128bh a,
                                    simde__m128bh b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128 simde_mm_maskz_dpbf16_ps(simde__mmask8 k,
                                     simde__m128 src,
                                     simde__m128bh a,
                                     simde__m128bh b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256 simde_mm256_dpbf16_ps(simde__m256 src, simde__m256bh a, simde__m256bh b)
{
#if defined(SIMDE_X86_AVX512BF16_NATIVE) && defined(SIMDE_X86_AVX512VL_NATIVE)
    return _mm256_dpbf16_ps(src, a, b);
#else
    simde__m256_private src_ = simde__m256_to_private(src);
    simde__m256bh_private a_ = simde__m256bh_to_private(a), b_ = simde__m256bh_to_private(b);
    ...
    simde__m256_private r1_[2], r2_[2];

    a_.u16 = SIMDE_SHUFFLE_VECTOR_(16,
                                   32,
                                   a_.u16,
                                   a_.u16,
                                   0,
                                   ...
                                   13,
                                   15);
    b_.u16 = SIMDE_SHUFFLE_VECTOR_(16,
                                   32,
                                   b_.u16,
                                   b_.u16,
                                   0,
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256 simde_mm256_mask_dpbf16_ps(simde__m256 src,
                                       simde__mmask8 k,
                                       simde__m256bh a,
                                       simde__m256bh b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256 simde_mm256_maskz_dpbf16_ps(simde__mmask8 k,
                                        simde__m256 src,
                                        simde__m256bh a,
                                        simde__m256bh b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512 simde_mm512_dpbf16_ps(simde__m512 src, simde__m512bh a, simde__m512bh b)
{
#if defined(SIMDE_X86_AVX512BF16_NATIVE)
    return _mm512_dpbf16_ps(src, a, b);
#else
    simde__m512_private src_ = simde__m512_to_private(src);
    simde__m512bh_private a_ = simde__m512bh_to_private(a), b_ = simde__m512bh_to_private(b);
    ...
    simde__m512_private r1_[2], r2_[2];
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512 simde_mm512_mask_dpbf16_ps(simde__m512 src,
                                       simde__mmask16 k,
                                       simde__m512bh a,
                                       simde__m512bh b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512 simde_mm512_maskz_dpbf16_ps(simde__mmask16 k,
                                        simde__m512 src,
                                        simde__m512bh a,
                                        simde__m512bh b)
{
