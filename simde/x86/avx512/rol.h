...
simde__m128i simde_mm_rol_epi32(simde__m128i a, int imm8) SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
{
...
#else
#define simde_mm_mask_rol_epi32(src, k, a, imm8)                                                   \
    simde_mm_mask_mov_epi32(src, k, simde_mm_rol_epi32(a, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm_maskz_rol_epi32(k, a, imm8)                                                       \
    simde_mm_maskz_mov_epi32(k, simde_mm_rol_epi32(a, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_rol_epi32(simde__m256i a, int imm8)
...
#else
#define simde_mm256_mask_rol_epi32(src, k, a, imm8)                                                \
    simde_mm256_mask_mov_epi32(src, k, simde_mm256_rol_epi32(a, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm256_maskz_rol_epi32(k, a, imm8)                                                    \
    simde_mm256_maskz_mov_epi32(k, simde_mm256_rol_epi32(a, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_rol_epi32(simde__m512i a, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
{
...
#else
#define simde_mm512_mask_rol_epi32(src, k, a, imm8)                                                \
    simde_mm512_mask_mov_epi32(src, k, simde_mm512_rol_epi32(a, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm512_maskz_rol_epi32(k, a, imm8)                                                    \
    simde_mm512_maskz_mov_epi32(k, simde_mm512_rol_epi32(a, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_rol_epi64(simde__m128i a, int imm8) SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
{
    simde__m128i_private r_, a_ = simde__m128i_to_private(a);

#if defined(SIMDE_POWER_ALTIVEC_P8_NATIVE)
    r_.altivec_i64 =
        vec_rl(a_.altivec_i64, vec_splats(HEDLEY_STATIC_CAST(unsigned long long, imm8)));
#elif defined(SIMDE_VECTOR_SUBSCRIPT_SCALAR)
    switch (imm8 & 63) {
        case 0:
            r_ = a_;
...
#else
#define simde_mm_mask_rol_epi64(src, k, a, imm8)                                                   \
    simde_mm_mask_mov_epi64(src, k, simde_mm_rol_epi64(a, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm_maskz_rol_epi64(k, a, imm8)                                                       \
    simde_mm_maskz_mov_epi64(k, simde_mm_rol_epi64(a, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_rol_epi64(simde__m256i a, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
{
    simde__m256i_private r_, a_ = simde__m256i_to_private(a);
    ...
    for (size_t i = 0; i < (sizeof(r_.m128i_private) / sizeof(r_.m128i_private[0])); i++) {
        r_.m128i_private[i].altivec_i64 =
            vec_rl(a_.m128i_private[i].altivec_i64,
                   vec_splats(HEDLEY_STATIC_CAST(unsigned long long, imm8)));
    }
#elif defined(SIMDE_VECTOR_SUBSCRIPT_SCALAR)
    switch (imm8 & 63) {
        case 0:
...
#else
#define simde_mm256_mask_rol_epi64(src, k, a, imm8)                                                \
    simde_mm256_mask_mov_epi64(src, k, simde_mm256_rol_epi64(a, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm256_maskz_rol_epi64(k, a, imm8)                                                    \
    simde_mm256_maskz_mov_epi64(k, simde_mm256_rol_epi64(a, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES) &&                                            \
    defined(SIMDE_X86_AVX512VL_ENABLE_NATIVE_ALIASES)
...
#else
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_rol_epi64(simde__m512i a, int imm8)
    SIMDE_REQUIRE_CONSTANT_RANGE(imm8, 0, 255)
{
    simde__m512i_private r_, a_ = simde__m512i_to_private(a);
...
#else
#define simde_mm512_mask_rol_epi64(src, k, a, imm8)                                                \
    simde_mm512_mask_mov_epi64(src, k, simde_mm512_rol_epi64(a, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
...
#else
#define simde_mm512_maskz_rol_epi64(k, a, imm8)                                                    \
    simde_mm512_maskz_mov_epi64(k, simde_mm512_rol_epi64(a, imm8))
#endif
#if defined(SIMDE_X86_AVX512F_ENABLE_NATIVE_ALIASES)
