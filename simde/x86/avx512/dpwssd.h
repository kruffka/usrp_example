...
simde__m128i simde_mm_dpwssd_epi32(simde__m128i src, simde__m128i a, simde__m128i b)
{
    ...
    src_.i32 += (r1_[0].i32 * r2_[0].i32) + (r1_[1].i32 * r2_[1].i32);
#else
    SIMDE_VECTORIZE
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_mask_dpwssd_epi32(simde__m128i src,
                                        simde__mmask8 k,
                                        simde__m128i a,
                                        simde__m128i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m128i simde_mm_maskz_dpwssd_epi32(simde__mmask8 k,
                                         simde__m128i src,
                                         simde__m128i a,
                                         simde__m128i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_dpwssd_epi32(simde__m256i src, simde__m256i a, simde__m256i b)
{
#if defined(SIMDE_X86_AVX512VL_NATIVE) && defined(SIMDE_X86_AVX512VNNI_NATIVE)
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_mask_dpwssd_epi32(simde__m256i src,
                                           simde__mmask8 k,
                                           simde__m256i a,
                                           simde__m256i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m256i simde_mm256_maskz_dpwssd_epi32(simde__mmask8 k,
                                            simde__m256i src,
                                            simde__m256i a,
                                            simde__m256i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_dpwssd_epi32(simde__m512i src, simde__m512i a, simde__m512i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_mask_dpwssd_epi32(simde__m512i src,
                                           simde__mmask16 k,
                                           simde__m512i a,
                                           simde__m512i b)
{
...
SIMDE_FUNCTION_ATTRIBUTES
simde__m512i simde_mm512_maskz_dpwssd_epi32(simde__mmask16 k,
                                            simde__m512i src,
                                            simde__m512i a,
                                            simde__m512i b)
{
